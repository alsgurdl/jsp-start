...
// 역할 http 요청 응답 처리에서 필요한 공통적인 부분을 쉽게 해경해 주는 자바api를 이용한 클래스
@WebServlet("/hello")//우리 웹서버에 /hello라는 url로 요청이 오변 이 서블릿을 실행시켜라
public class helloServlet extends HttpServlet {//HttpServlet을 상속을 받는다

//기본 생성자
    public helloServlet() {
    //요청이 들어오면 서블릿 객체가 서버 내에서 자동 생성
        System.out.println("\n\n\n hello 서블릿 시작 \n\n\n");
    }
    //요청 정보 얻어보기
    ...
    //메개값으로 요청에 대한 정보가 담긴 HttpServletRequest와
    //응답에 대한 정보 및 기능이 담긴HttpServletRequest를 전달 받습니다
